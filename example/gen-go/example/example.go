...
type ExampleRes struct {
	...
	Map1     map[string]string `thrift:"map1,3" db:"map1" json:"map1"`
}
...
func (p *ExampleRes) GetMap1() map[string]string {
	return p.Map1
}
...
func (p *ExampleRes) ReadField3(iprot thrift.TProtocol) error {
...
func (p *ExampleRes) writeField3(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("map1", thrift.MAP, 3); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:map1: ", p), err)
	}
	if err := oprot.WriteMapBegin(thrift.STRING, thrift.STRING, len(p.Map1)); err != nil {
	...
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 3:map1: ", p), err)
	}
	return err
}
...
func (p *ExampleServiceClient) GetResponse(ctx context.Context, req *ExampleReq) (r *ExampleRes, err error) {
	var _args2 ExampleServiceGetResponseArgs
	_args2.Req = req
	var _result3 ExampleServiceGetResponseResult
...
func NewExampleServiceProcessor(handler ExampleService) *ExampleServiceProcessor {
	...
	self4.processorMap["get_response"] = &exampleServiceProcessorGetResponse{handler: handler}
	return self4
}
